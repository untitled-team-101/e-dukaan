      ...
      <div className="of-hidden">
        <nav className="navbar w-100 sticky-top navbar-dark bg-primary">
          <div className="container-fluid row">
            ...
            <div className="col-lg-8 col-md-6 col-6"><Link className="navbar-brand brand-name-nav" to="#"><i
              className="fab fa-opencart"/> E-DUKAAN</Link></div>
            <div className="col-lg-2 col-md-3 col-2">
              <Link to='/cart'className="nav-link active cart-btn" aria-current="page" href="/"><i
